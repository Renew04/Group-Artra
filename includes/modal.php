...
<!-- end of Employee select and script -->
  ...
  <!-- Logout Modal-->
  <div class="modal fade" id="logoutsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body"> Brian Esperas are you sure do you want to logout?</div>
        ...
        <div class="modal-body">
          <form role="form" method="post" action="cust_pos_trans.php?action=add">
            <div class="form-group">
              <input class="form-control" placeholder="Enter Transaction Name" name="firstname" required>
            </div>
            <hr>
