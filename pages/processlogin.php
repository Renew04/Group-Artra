...
//create some sql statement             
        ...
        WHERE  `USERNAME` ='" . $users . "' AND  `PASSWORD` =  '" . $h_upass . "' AND `Status` = 'Active'";
        $result = $db->query($sql);
        ...
        if ($_SESSION['TYPE']=='Admin'){
             ...
             ?>    <script type="text/javascript">
                      ...
                      alert("<?php echo  $_SESSION['FIRST_NAME']; echo " "; echo $_SESSION['LAST_NAME'];?> Welcome!");
            ...
            //IF theres no result
              ?>
                <script type="text/javascript">
                alert("Username or Password Not Registered! OR Suspended Account, Contact Your administrator.");
                window.location = "index.php";
                </script>
              <?php
