              ...
              <div class="modal-body">
                  <div class="form-group row text-left mb-2">
                    ...
                    <div class="col-sm-12 text-center">
                      ...
                      <input type="hidden" name="subtotal" value="<?php if (isset($total)){ echo "₱ "; echo number_format($total, 2); }else{ echo "Data not available";} ?>">
                        <?php if (isset($total)){ echo "₱ "; echo number_format($total, 2); }else{ echo "Data not available";} ?>
                      </h3>
                    </div>
